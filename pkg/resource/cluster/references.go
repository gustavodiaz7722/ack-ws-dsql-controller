...
func (rm *resourceManager) ClearResolvedReferences(res acktypes.AWSResource) acktypes.AWSResource {
	...
	if ko.Spec.KMSEncryptionKeyRef != nil {
		ko.Spec.KMSEncryptionKey = nil
	}
...
func (rm *resourceManager) ResolveReferences(
	...
	if fieldHasReferences, err := rm.resolveReferenceForKMSEncryptionKey(ctx, apiReader, ko); err != nil {
...
func validateReferenceFields(ko *svcapitypes.Cluster) error {
	...
	if ko.Spec.KMSEncryptionKeyRef != nil && ko.Spec.KMSEncryptionKey != nil {
		return ackerr.ResourceReferenceAndIDNotSupportedFor("KMSEncryptionKey", "KMSEncryptionKeyRef")
	}
	return nil
}

// resolveReferenceForKMSEncryptionKey reads the resource referenced
// from KMSEncryptionKeyRef field and sets the KMSEncryptionKey
// from referenced resource. Returns a boolean indicating whether a reference
// contains references, or an error
func (rm *resourceManager) resolveReferenceForKMSEncryptionKey(
	ctx context.Context,
	apiReader client.Reader,
	ko *svcapitypes.Cluster,
) (hasReferences bool, err error) {
	if ko.Spec.KMSEncryptionKeyRef != nil && ko.Spec.KMSEncryptionKeyRef.From != nil {
		hasReferences = true
		arr := ko.Spec.KMSEncryptionKeyRef.From
		if arr.Name == nil || *arr.Name == "" {
			return hasReferences, fmt.Errorf("provided resource reference is nil or empty: KMSEncryptionKeyRef")
		}
		...
		ko.Spec.KMSEncryptionKey = (*string)(obj.Status.ACKResourceMetadata.ARN)
	}
